""" I have supress all the '__' at the beginning of the functions because I couldn't find there, I put only one '_' in front of them, or sometimes even zero
"""
 # line 308 : ERROR ?
...
# this function is exactly the same than _single_argument_regex(self, arg, curr_filter) ?!
    def _not_regex(self, curr_filter, s):
        """
